...
fun MultiplicationScreen(navController: NavController) {
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            LevelButtonMultiplication(stringResource(R.string.easy)) {  }
            Spacer(modifier = Modifier.height(16.dp))
            LevelButtonMultiplication(stringResource(R.string.medium)) {  }
            Spacer(modifier = Modifier.height(16.dp))
            LevelButtonMultiplication(stringResource(R.string.hard)) {  }
        }
    }
}
