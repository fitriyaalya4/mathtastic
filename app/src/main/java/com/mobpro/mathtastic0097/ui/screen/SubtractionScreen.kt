...
fun SubtractionScreen(navController: NavController) {
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            LevelButtonSubtraction(stringResource(R.string.easy)) {  }
            Spacer(modifier = Modifier.height(16.dp))
            LevelButtonSubtraction(stringResource(R.string.medium)) {  }
            Spacer(modifier = Modifier.height(16.dp))
            LevelButtonSubtraction(stringResource(R.string.hard)) {  }
        }
    }
}
